...
function InfoBar() {
	return (
		<div className="mt-16 w-full flex items-center justify-between border-t border-white/10 pt-6">
			<div
			...
			<div
				className="text-white text-2xl tracking-tight overflow-hidden"
				style={{ letterSpacing: "-0.72px" }}
			>
			...
			<a
				href="#about"
				className={`w-10 h-10 rounded-full border ${colors.borderInteractive} flex items-center justify-center hover:bg-white/5 transition-colors shrink-0`}
			>
	...
	return (
		<header className="relative min-h-screen flex flex-col justify-center hero-gradient overflow-hidden">
			...
			<div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-12 w-full flex flex-col items-center">
				...
				<div className="mt-2 text-center flex items-baseline justify-center gap-3">
					<h3
						className="text-2xl md:text-[34px] font-medium text-white"
						style={{ letterSpacing: "-1.36px", lineHeight: "1.3" }}
					>
						AI Bootcamp for the
					</h3>
					<span
						className="text-3xl md:text-[44px] font-semibold italic text-white inline-block min-w-[220px] text-left"
						style={{ letterSpacing: "-1.36px", lineHeight: "1.3" }}
					>
						{currentWord}
					</span>
