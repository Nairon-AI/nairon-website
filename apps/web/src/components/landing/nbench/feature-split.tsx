				...
				<div className="grid lg:grid-cols-2">
					<div className="px-1 py-12 md:px-8 md:py-16 lg:pr-16">
						...
						<div className="relative mt-10">
							...
							>
								...
								<div className="mt-5 space-y-4 font-inter text-[14px] text-white/58">
									<div className="flex flex-wrap items-center gap-2">
										<span className="w-[112px] text-white/58">Suggestions</span>
									...
									<div className="flex items-center gap-3">
										<span className="w-[112px] text-white/58">Duplicate of</span>
										<span className="text-white/65">{left.duplicateOf}</span>
									</div>
									<div className="flex items-center gap-3">
										<span className="w-[112px] text-white/58">Related to</span>
							...
							<LinearGlassCard
								...
								innerClassName="relative overflow-hidden border-white/[0.08] bg-[rgba(12,12,12,0.95)] p-5"
							>
								<div className="pointer-events-none absolute inset-0 bg-[linear-gradient(160deg,rgba(255,255,255,0.06),transparent_38%)]" />
								<p className="font-inter text-[16px] font-[520] tracking-[-0.02em] text-white">alex</p>
								<div className="mt-3 border-t border-white/[0.08] pt-4">
									<p className="font-inter text-[16px] font-[530] tracking-[-0.02em] text-white">
										{left.popover.headline}
									</p>
									<p className="mt-3 font-inter text-[14px] leading-[1.45] text-white/58">
										{left.popover.description}
									</p>
								</div>
								<div className="mt-4 border-t border-white/[0.08] pt-4">
									<p className="font-inter text-[15px] font-[520] text-white/85">Alternatives</p>
					...
					<div className="px-1 py-12 md:px-8 md:py-16 lg:pl-16">
						...
						<div className="relative mt-10 max-w-[560px] pb-3">
							<div className="pointer-events-none absolute -inset-x-14 -top-12 h-36 bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,0.08),transparent_70%)] blur-2xl" />
							<LinearGlassCard
								className="relative w-full overflow-hidden shadow-[0_30px_80px_rgba(0,0,0,0.68)] after:pointer-events-none after:absolute after:inset-0 after:rounded-[10px] after:bg-[linear-gradient(90deg,rgba(0,0,0,0)_24%,rgba(0,0,0,1)_100%)] after:content-['']"
								innerClassName="relative overflow-hidden border-white/[0.06] bg-[linear-gradient(165deg,rgba(16,16,16,0.98)_0%,rgba(11,11,11,0.98)_100%)] px-6 py-5"
							>
								<div className="pointer-events-none absolute inset-0 bg-[linear-gradient(155deg,rgba(255,255,255,0.07),transparent_35%)]" />
								<p className="font-mono text-[14px] tracking-[0.02em] text-white/24">{right.endpoint}</p>
								<div className="mt-5 space-y-2 font-mono text-[14px] leading-[1.5] text-white/45 md:text-[15px]">
									{right.config.map((line) => (
										<p key={line}>{line}</p>
									))}
								</div>
							</LinearGlassCard>
							...
							<LinearGlassCard
								className="relative -mt-2 mr-4 ml-5 overflow-hidden shadow-[0_38px_95px_rgba(0,0,0,0.76)] after:pointer-events-none after:absolute after:inset-0 after:rounded-[10px] after:bg-[linear-gradient(90deg,rgba(0,0,0,0)_20%,rgba(0,0,0,1)_100%)] after:content-[''] md:-mt-10 md:mr-0 md:ml-10"
								innerClassName="relative overflow-hidden border-white/[0.1] bg-[rgba(24,24,24,0.92)] px-5 py-5"
							>
								<div className="pointer-events-none absolute inset-0 bg-[linear-gradient(160deg,rgba(255,255,255,0.07),transparent_36%)]" />
								<div className="flex items-center gap-3">
									<span className="h-6 w-px bg-white/58" />
									<p className="font-inter text-[16px] text-white/68">{right.prompt}</p>
								</div>
								<div className="mt-6 flex flex-wrap gap-2">
									{right.actions.map((action) => {
										...
										return (
											<span
												key={action}
												className="inline-flex items-center gap-1.5 rounded-full border border-white/[0.14] bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.02))] px-3.5 py-1.5 font-inter text-[13px] text-white/62 shadow-[inset_0_1px_0_rgba(255,255,255,0.07)]"
											>
