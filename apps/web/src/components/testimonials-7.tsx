...
const testimonialsData = [
    {
        ...
        text: 'N-bench changed how our team works with Claude Code. We stopped jumping straight into implementation and now run interview, plan, and review loops that catch misses early.',
    ...
    },
    {
        ...
        text: 'The /nbench:improve recommendations were practical, not generic. We installed two MCPs and immediately saw better context retention across long sessions.',
    ...
    },
    {
        ...
        text: 'For leadership, N-bench gives a clear picture of AI collaboration maturity. We can now coach teams using data instead of anecdotes.',
