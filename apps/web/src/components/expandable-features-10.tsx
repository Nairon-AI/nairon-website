        ...
        <section id="nbench-architecture" className="bg-background @container scroll-mt-28 pt-24">
            <div className="mx-auto max-w-5xl px-6">
                <div className="max-w-lg">
                    ...
                    <p className="text-muted-foreground mx-auto mt-3 max-w-lg text-lg">Three connected layers: in-agent runtime, recommendation intelligence, and enterprise observability.</p>
                </div>
            </div>
                    ...
                    <div className="grid items-end max-lg:gap-12 lg:grid-cols-5">
                        ...
                        <div className="@lg:grid-cols-[auto_1fr] flex grid gap-2 max-lg:row-start-1 max-lg:mx-auto max-lg:w-full max-lg:max-w-md lg:col-span-3">
                            ...
                            <motion.div
                                ...
                                <p className="text-muted-foreground w-44 text-balance text-sm">Each layer reinforces the same loop: detect friction, recommend fixes, measure improvement.</p>
                            </motion.div>
                        </div>
                    </div>
                </div>
